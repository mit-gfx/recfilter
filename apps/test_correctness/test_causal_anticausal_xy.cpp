...
int main(int argc, char **argv) {
    ...
    filter.add_anticausal_filter(x, {1.0f, W(1,0), W(1,1), W(1,2)});
    filter.add_causal_filter    (y, {1.0f, W(2,0), W(2,1), W(2,2)});
    filter.add_anticausal_filter(y, {1.0f, W(3,0), W(3,1), W(3,2)});
