...
int main(int argc, char **argv) {
    ...
    filter.addScan(x, rx, Internal::vec(W(2,0), W(2,1)), RecFilter::CAUSAL);
    filter.addScan(x, rx, Internal::vec(W(3,0), W(3,1)), RecFilter::ANTICAUSAL);
    filter.addScan(y, ry, Internal::vec(W(4,0), W(4,1)), RecFilter::CAUSAL);
    filter.addScan(y, ry, Internal::vec(W(5,0), W(5,1)), RecFilter::ANTICAUSAL);
    filter.addScan(y, ry, Internal::vec(W(6,0), W(6,1)), RecFilter::ANTICAUSAL);
