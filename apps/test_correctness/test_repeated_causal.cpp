...
int main(int argc, char **argv) {
    ...
    filter.addScan(x, rx, Internal::vec(W(1,0), W(1,1), W(1,2)));
    filter.addScan(x, rx, Internal::vec(W(2,0), W(2,1), W(2,2)));
    filter.addScan(x, rx, Internal::vec(W(3,0), W(3,1), W(3,2)));
