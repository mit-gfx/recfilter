...
/*
    Biquintic Bspline filter

    Biquintic Bspline filter created by converting NVIDIA CUDA toolkit
    recursive Gaussian into second order -> performance wise this is
    equivalent to Gaussian because NVIDIA's Gaussian is second order
